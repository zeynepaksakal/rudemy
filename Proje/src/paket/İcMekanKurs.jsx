...
import Kurslarimiz1 from "../../../publicKurslarThumbnails/iç mekan tasarımı.png";
...
const IcMekanKurs = () => {
  ...
  const yorumlar = [
    {
      ad: "Ahmet Yılmaz",
      yorum: "Harika bir kurs, teknik çizimler konusunda çok şey öğrendim!",
      puan: 5,
    },
    {
      ad: "Zeynep Demir",
      yorum: "İçerik kaliteli ama daha fazla pratik uygulama olabilirdi.",
      puan: 4,
    },
  ];
      ...
      <div className="konteyner">
        <div className="kurs-karti">
          ...
          <div className="kurs-icerik">
            <h2 className="kurs-baslik">İç Mekan Tasarımı</h2>
            <div className="fiyat">
              <s>249.99TL</s> <strong>149.99TL</strong>
            </div>
            <div className="ogretmen-bilgi">
              <span>Sorumlu Öğretmen:</span> <strong>Canmert Demir</strong>
            </div>
            ...
            <div className="paket-icerigi">
              ...
              <ul>
                ...
                <li>- Teknik Çizim ve Görselleştirme</li>
                <li>- Ergonomi ve İnsan-Mekan İlişkisi</li>
                <li>- Malzeme ve Yapı Bilgisi</li>
              </ul>
            </div>
              ...
              <div className="sekme-icerik">
                {aktifSekme === "aciklama" && (
                  <div className="aciklama">
                    <p>
                      İç mekan tasarımı kursunda mekan düzenlemesi, estetik ve fonksiyonel tasarım ilkelerini öğreneceksiniz. Teknik çizim ve görselleştirme konularına hakim olup ergonomi ve insan-mekan ilişkisini detaylı bir şekilde kavrayacaksınız.
                    </p>
                  </div>
                )}
