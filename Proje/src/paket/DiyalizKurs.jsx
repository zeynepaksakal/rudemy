...
import Kurslarimiz1 from "../../../publicKurslarSaglik/diyaliz1.png";
...
const DiyalizKurs = () => {
  ...
  const yorumlar = [
    {
      ad: "Ahmet Yılmaz",
      yorum: "Diyaliz sürecini tüm detaylarıyla öğrenmek için harika bir kurs!",
      puan: 5,
    },
    {
      ad: "Zeynep Demir",
      yorum: "Hasta bakımı bölümü çok faydalıydı, daha fazla vaka incelemesi olsa harika olurdu!",
      puan: 4,
    },
  ];
      ...
      <div className="konteyner">
        <div className="kurs-karti">
          ...
          <div className="kurs-icerik">
            <h2 className="kurs-baslik">Diyaliz</h2>
            <div className="fiyat">
              <s>299.99TL</s> <strong>229.99TL</strong>
            </div>
            <div className="ogretmen-bilgi">
              <span>Sorumlu Öğretmen:</span> <strong>Hamza Zübeyir Güneş</strong>
            </div>

            <div className="paket-icerigi">
              <h4>Paket İçeriği</h4>
              <ul>
                <li>- Diyaliz Süreci ve Teknolojisi</li>
                <li>- Hasta Bakımı ve Takibi</li>
                <li>- Acil Durum Yönetimi</li>
                <li>- Uygulamalı Eğitim ve Staj</li>
              </ul>
            </div>
              ...
              <div className="sekme-icerik">
                {aktifSekme === "aciklama" && (
                  <div className="aciklama">
                    <p>
                      Diyaliz kursunda diyaliz süreci, hasta bakımı ve acil durum yönetimi hakkında kapsamlı bilgiler öğreneceksiniz. Uygulamalı eğitim ve staj imkanlarıyla öğrendiklerinizi pratikte uygulayabileceksiniz.
                    </p>
                  </div>
                )}
