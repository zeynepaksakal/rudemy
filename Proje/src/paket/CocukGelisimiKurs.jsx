...
import Kurslarimiz1 from "../../../publicKurslarSaglik/çocukgelişimi1.png";

const CocukGelisimiKurs = () => {
  ...
  const yorumlar = [
    {
      ad: "Ahmet Yılmaz",
      yorum: "Çocuk gelişimi konusunda çok önemli bilgiler içeriyor!",
      puan: 5,
    },
    {
      ad: "Zeynep Demir",
      yorum: "Eğitim içeriği güzel ama daha fazla uygulamalı anlatım olabilirdi.",
      puan: 4,
    },
  ];
      ...
      <div className="konteyner">
        <div className="kurs-karti">
          ...
          <div className="kurs-icerik">
            <h2 className="kurs-baslik">Çocuk Gelişimi</h2>
            <div className="fiyat">
              <s>399.99TL</s> <strong>299.99TL</strong>
            </div>
            <div className="ogretmen-bilgi">
              <span>Sorumlu Öğretmen:</span> <strong>Elif Türel</strong>
            </div>

            <div className="paket-icerigi">
              <h4>Paket İçeriği</h4>
              <ul>
                <li>- Çocuk Gelişim Temelleri</li>
                <li>- Eğitim ve Öğretim Yöntemleri</li>
                <li>- Aile ve Çocuk İlişkileri</li>
                <li>- Sağlık ve Beslenme</li>
              </ul>
            </div>
              ...
              <div className="sekme-icerik">
                {aktifSekme === "aciklama" && (
                  <div className="aciklama">
                    <p>
                      Çocuk gelişimi kursunda çocukların gelişim süreçlerine dair temel bilgileri öğrenerek eğitim ve öğretim yöntemlerini keşfedeceksiniz. Aile ile çocuk arasındaki ilişkileri anlamlandırıp sağlık ve beslenme konusunda uzmanlaşacaksınız.
                    </p>
                  </div>
                )}
...
export default CocukGelisimiKurs;
