...
import Kurslarimiz1 from "../../../publicKurslarSaglik/anestezi1.png";
...
const AnesteziKurs = () => {
  ...
  const yorumlar = [
    {
      ad: "Ahmet Yılmaz",
      yorum: "Temel tıp bilgileri çok iyi aktarılmış, klinik uygulamalar harika!",
      puan: 5,
    },
    {
      ad: "Zeynep Demir",
      yorum: "Eğitim kaliteli, ancak mesleki etik konusunda daha fazla örnek olabilirdi.",
      puan: 4,
    },
  ];
      ...
      <div className="konteyner">
        <div className="kurs-karti">
          ...
          <div className="kurs-icerik">
            <h2 className="kurs-baslik">Anestezi</h2>
            <div className="fiyat">
              <s>299.99TL</s> <strong>199.99TL</strong>
            </div>
            <div className="ogretmen-bilgi">
              <span>Sorumlu Öğretmen:</span> <strong>Berat Çağlar Öztürk</strong>
            </div>

            <div className="paket-icerigi">
              <h4>Paket İçeriği</h4>
              <ul>
                <li>- Temel Tıp Bilgisi</li>
                <li>- Klinik Uygulamalar</li>
                <li>- Mesleki ve Etik Bilgiler</li>
                <li>- Anesteziye Özel Bilgiler</li>
              </ul>
            </div>
              ...
              <div className="sekme-icerik">
                {aktifSekme === "aciklama" && (
                  <div className="aciklama">
                    <p>
                      Anestezi kursunda temel tıp bilgilerini öğrenip klinik uygulamalar hakkında bilgi sahibi olacaksınız. Mesleki ve etik konulara dair detaylı eğitim alarak anesteziye özel bilgileri öğreneceksiniz.
                    </p>
                  </div>
                )}
